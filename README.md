...
Once drivers surpassed 100 miles with a perfect 100 Safety Score after 7 days, Tesla started delivering FSD Beta to those vehicles by updating them to 2021.36.5. Some vehicles were updated from 2021.32.22 and some from 2021.32.25. My car never left 2021.32.22, so I watched that population fairly closely. Any Tesla that was "FSD ready" could be upgraded to FSD Beta, though, so I also specifically wanted to know each time a vehicle similar to mine was upgraded. FSD Beta went through a few updates within the first couple of weeks, so the current target firmware version changed every few days. Right now, 2021.36.5.3 (aka FSD Beta 10.3.1) is the latest and the version this script is monitoring.
